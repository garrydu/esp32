...
#define TFT_MISO 9  // Automatically assigned with ESP8266 if not defined
#define TFT_MOSI 10 // Automatically assigned with ESP8266 if not defined
#define TFT_SCLK 8  // Automatically assigned with ESP8266 if not defined
